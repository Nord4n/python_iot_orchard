...
- Add, view, edit and search trees
- Each tree tracks: ID, variety, planted year, harvest time, known problems, and pruning status for the current year
- Data is saved to and loaded from a JSON file, so the orchard persists between runs
